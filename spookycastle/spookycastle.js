...
var wasmBinaryFile = 'spookycastle.wasm';
...
var ASM_CONSTS = {
  4859: function() {HamSandwich.fsSync();},  
 6601: function() {Module.requestFullscreen();},  
 120388: function($0, $1) {alert(UTF8ToString($0) + "\n\n" + UTF8ToString($1));},  
 ...
 125104: function($0) {if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } return 0;},  
 125197: function() {if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; }},  
 126422: function() {return screen.width;},  
 126449: function() {return screen.height;},  
 126477: function() {return window.innerWidth;},  
 126509: function() {return window.innerHeight;},  
 126587: function($0) {if (typeof setWindowTitle !== 'undefined') { setWindowTitle(UTF8ToString($0)); } return 0;},  
 126721: function() {if (typeof(AudioContext) !== 'undefined') { return 1; } else if (typeof(webkitAudioContext) !== 'undefined') { return 1; } return 0;},  
 126887: function() {if ((typeof(navigator.mediaDevices) !== 'undefined') && (typeof(navigator.mediaDevices.getUserMedia) !== 'undefined')) { return 1; } else if (typeof(navigator.webkitGetUserMedia) !== 'undefined') { return 1; } return 0;},  
